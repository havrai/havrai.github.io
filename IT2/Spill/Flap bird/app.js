(function() {
    ...
    //Load assets
    var bgImg = loadImage('assets/bakgrunn.png', 300, 450),
        playerImg = loadImage('assets/bird.png', 192, 64),
        enemyUpImg = loadImage('assets/pipeSouth.png', 64, 316),
        enemyDownImg = loadImage('assets/pipeNorth.png', 64, 316);
